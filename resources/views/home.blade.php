...
<head>
    ...
    <meta name="author" content="agungwicaksonosurasno" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Undangan" />
    <meta property="og:url" content="https://rachma-agung" />
    <meta property="og:site_name" content="undangan" />
    {{-- <meta http-equiv="refresh" content="0; URL=http://rachma-agung/assets/mp3/backsound.mp3" /> --}}
    <title>Rachma & Agung Wedding</title>
    ...
    <link rel="stylesheet" href="assets/undangan/css/comment.css">
...
<body id="top" class="ss-preload theme-slides" onMouseover="PlayStop()" onclick="PlayStop()">
    ...
    {{-- <button id="btn" onclick="PlayStop()" type="button">Play</button> --}}

    {{-- <embed src="{{ url('assets/mp3/silence.mp3') }}" type="audio/mp3" autostart="true" hidden="true"> --}}
    <audio loop autoplay id="audio" hidden type="audio/mp3" allow="autoplay" controls="false">
        <source src="{{ url('assets/mp3/backsound.mp3') }}">
    </audio>
    {{-- <iframe src="{{ url('assets/mp3/backsound.mp3') }}" height="300" width="300" allowfullscreen=""></iframe> --}}
    ...
    <section id="intro" class="s-intro">
        ...
        <div class="s-intro__slider swiper-container" onclick="PlayStop()">
            <div class="swiper-wrapper">
                <div class="s-intro__slide swiper-slide" style="background-image: url(assets/img/hero-1.jpg);">
                </div>
                <div class="bg-opacity-50 s-intro__slide swiper-slide"
                    style="background-image: url(assets/img/hero-2.jpg);"></div>
                <div class="s-intro__slide swiper-slide bg-opacity-10"
                    style="background-image: url(assets/img/hero-3.jpg);"></div>
            </div>
        </div>
    ...
    <section id="details" class="s-details">
        ...
        <div class="row">
            <div class="column">
                <p class="text-center desc-bride">For : </p>
                <h1 class="text-center text-huge-title">
                    {{ $to }}

                </h1>
                <p class="text-center">We are inviting you to the wedding<br><br></p>
                                ...
                                <div class="row">
                                    @foreach ($bride as $item)
                                        <div class="column lg-6 tab-12">
                                            ...
                                            <br>
                                            <img src="{{ asset('assets/bride') }}/{{ $item->photo }}"
                                ...
                                <div class="column services-list__item">
                                    <div class="services-list__item-content">
                                        ...
                                        <p class="desc-bride">
                                            ...
                                            @foreach ($wedding as $item)
                                                <a href="https://www.google.com/calendar/render?action=Rachma-Agung-Wedding&text=Pernikahan%20Fini%20%26%20&details=Kami%20sangat%20berharap%20anda%20dapat%20hadir%20di%20moment%20bahagia%20ini&location=GEDUNG%20MAYOR%20JENDRAL%20AR%20MOER&dates=20221023T010000Z%2F20221023T080000Z&ctz=Asia%2FJakarta"
                    ...
                    <div id="tab-gallery" class="tab-content__item">
                        <div class="row">
                            <div class="column">
                                <div class="row">
                                    <div class="column lg-6 tab-12">
                                        <p class="name-bride">{{ '' }}</p>
                                        <br>
                                        <img src="{{ asset('assets/gallery') }}/1.jpeg"
                                            style="height:500px; widht:auto;">
                                    </div>
                                    <div class="column lg-6 tab-12">
                                        <p class="name-bride">{{ '' }}</p>
                                ...
                                <div class="row">
                                    <div class="column lg-12 tab-12">
                                        ...
                                        <img src="{{ asset('assets/gallery') }}/6.jpg"
                                            style="height:500px; widht:600px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="column">
                                <div class="row">
                                    <div class="column lg-6 tab-12">
                                        <p class="name-bride">{{ '' }}</p>
                                        <br>
                                        <img src="{{ asset('assets/gallery') }}/2.jpeg"
                                            style="height:500px; widht:auto;">
                                    </div>
                                    <div class="column lg-6 tab-12">
                                        <p class="name-bride">{{ '' }}</p>
                        ...
                        <div class="row">
                            ...
                            <div class="column lg-6 tab-12">
                                <form action="{{ route('home.store') }}" method="POST">
                                    ...
                                    <input type="hidden" name="wedding_id" value="1">
                                    <div>
                                        <label for="sampleInput">Full name</label>
                                        <input class="u-fullwidth" type="text" placeholder="Full name"
                                            value="{{ $to }}" id="name" name="name">
                                    </div>
                                    <br>
                                    <br>
                                    <label for="exampleMessage">Message</label>
                                    <textarea class="u-fullwidth" placeholder="Your message" id="comment" name="comment"></textarea>
                ...
                <footer>
                    <div class="ss-copyright">
                        ...
                        @endforeach
                        <span>Developed by <a href="https://wa.me/6281233661927" target="_blank">agung wicaksono
                                surasno</a></span>
                    </div>
                </footer>
    ...
    <Script>
        ...
        (function(html) {
            ...
            const cfg = {
                ...
                finalDate: 'October 22, 2022 09:00:00',
                // MailChimp URL
